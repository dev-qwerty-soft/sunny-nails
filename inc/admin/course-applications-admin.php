...
function display_course_applications_page() {
  ...
  $courses = $wpdb->get_results(
    "SELECT DISTINCT course_title FROM $table_name ORDER BY course_title",
  );
  ?>
    <div class="wrap">
        ...
        <form method="get" style="margin-bottom: 20px;">
            ...
            <select name="status" id="status">
                ...
                <option value="contacted" <?php selected(
                  $status_filter,
                  'contacted',
                ); ?>>Contacted</option>
                <option value="enrolled" <?php selected(
                  $status_filter,
                  'enrolled',
                ); ?>>Enrolled</option>
                <option value="rejected" <?php selected(
                  $status_filter,
                  'rejected',
                ); ?>>Rejected</option>
            </select>
            ...
            <input type="date" name="date_from" id="date_from" value="<?php echo esc_attr(
              $date_from,
            ); ?>">

            <label for="date_to">To:</label>
            <input type="date" name="date_to" id="date_to" value="<?php echo esc_attr(
              $date_to,
            ); ?>">
                        ...
                        <?php foreach ($applications as $app): ?>
                            <tr>
                                ...
                                <td><a href="mailto:<?php echo esc_attr(
                                  $app->applicant_email,
                                ); ?>"><?php echo esc_html($app->applicant_email); ?></a></td>
                                <td><a href="tel:<?php echo esc_attr(
                                  $app->phone_country . $app->applicant_phone,
                                ); ?>"><?php echo esc_html(
  $app->phone_country . ' ' . $app->applicant_phone,
); ?></a></td>
                                <td>
