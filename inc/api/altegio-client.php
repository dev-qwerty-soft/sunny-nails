...
class AltegioClient
{
    ...
    private static function request(string $endpoint, array $params = [], string $method = 'GET', array $body = []): array
    {
        ...
        return [
            'success' => in_array($code, [200, 201, 204]) && (!isset($data['success']) || $data['success'] !== false),
    ...
    {
        $response = self::request('company/' . self::COMPANY_ID . '/service_categories/' . $category_id);
    ...
    public static function createService(array $data): array
    {
        ...
        $response = self::request('company/' . self::COMPANY_ID . '/services', [], 'POST', $serviceData);
    ...
    public static function createServiceCategory(array $data): array
    {
        ...
        $response = self::request('company/' . self::COMPANY_ID . '/service_categories', [], 'POST', $categoryData);
    ...
    public static function updateService($service_id, array $data): array
    {
        ...
        $response = self::request('company/' . self::COMPANY_ID . '/services/' . $service_id, [], 'PUT', $serviceData);
    ...
    public static function updateStaff($staff_id, array $data): array
    {
        ...
        $response = self::request('company/' . self::COMPANY_ID . '/staff/' . $staff_id, [], 'PUT', $staffData);
    ...
    public static function updateServiceCategory($category_id, array $data): array
    {
        ...
        $response = self::request('company/' . self::COMPANY_ID . '/service_categories/' . $category_id, [], 'PUT', $categoryData);
    ...
    {
        $response = self::request('company/' . self::COMPANY_ID . '/services/' . $service_id, [], 'DELETE');
    ...
    {
        $response = self::request('company/' . self::COMPANY_ID . '/service_categories/' . $category_id, [], 'DELETE');
    ...
    {
        $response = self::request('company/' . self::COMPANY_ID . '/records/' . $record_id, [], 'PUT', $data);
    ...
    {
        $response = self::request('company/' . self::COMPANY_ID . '/records/' . $record_id, [], 'DELETE');
