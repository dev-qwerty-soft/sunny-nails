                        ...
                        <div class="partners-hero__benefit">
                            ...
                            <div class="partners-hero__benefit-text">
                                <?php if (!empty($item['title'])): ?>
                                    <div class="partners-hero__benefit-title"><?= esc_html($item['title']) ?></div>
                                <?php endif; ?>
                                <?php if (!empty($item['description'])): ?>
                                    <div class="partners-hero__benefit-desc"><?= esc_html($item['description']) ?></div>
                                <?php endif; ?>
                            </div>
                        </div>
                    <?php endforeach; ?>
    ...
    <section class="partner-program">
        <div class="partner-program__container">
            ...
            <div class="partner-program__content">
                ...
                <div class="partner-program__desc"><?php the_field('partner_program_description'); ?></div>
            </div>
        </div>
    </section>
    ...
    <section class="partners-section">
        ...
        <div class="partners-filter">
            ...
            <?php foreach ($cats as $cat): ?>
                <button class="partners-filter__btn" data-cat="<?= esc_attr($cat->slug) ?>"><?= esc_html($cat->name) ?></button>
            <?php endforeach; ?>
        </div>

        <div class="partners-list">
            <?php foreach ($partners_arr as $partner): ?>
                <div class="partner-card" data-cats="<?= esc_attr(implode(' ', $partner['cats'])) ?>">
                    ...
                    <div class="partner-card__content">
                            ...
                            <div class="partner-card__benefit">
                                <div class="partner-card__benefit-icon">
                                    <?php if ($partner['benefit_icon']): ?>
                                        <img src="<?= esc_url($partner['benefit_icon']['url']) ?>" alt="<?= esc_attr($partner['benefit_icon']['alt']) ?>">
                                    <?php endif; ?>
                                </div>
                        ...
                        <div class="partner-card__btns">
                            ...
                            <?php if ($partner['link']): ?>
                                <a href="<?= esc_url($partner['link']) ?>" target="_blank" class="partner-card__btn white"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                    ...
                    <div class="partner-popup__content">
                        ...
                        <?php if ($partner['benefit_title'] || $partner['benefit_desc']): ?>
                            <div class="partner-popup__benefit-box">
                                <div class="partner-card__benefit">
                                    <?php if ($partner['benefit_icon']): ?>
                                        <div class="partner-popup__benefit-icon"><img src="<?= esc_url($partner['benefit_icon']['url']) ?>" alt="<?= esc_attr($partner['benefit_icon']['alt']) ?>"></div>
                                    <?php endif; ?>
                                    <?php if ($partner['benefit_title']): ?>
                        ...
                        <?php endif; ?>
                        <?php if ($partner['link']): ?>
                            <a href="<?= esc_url($partner['link']) ?>" target="_blank" class="partner-popup__link">Visit the partner’s website</a>
                        <?php endif; ?>
                    </div>
