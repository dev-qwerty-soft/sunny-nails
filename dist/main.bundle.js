...
/* harmony import */ var swiper_css_scrollbar__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! swiper/css/scrollbar */ "../node_modules/swiper/modules/scrollbar.css");
/* harmony import */ var swiper__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! swiper */ "../node_modules/swiper/swiper.mjs");
/* harmony import */ var _js_map_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./js/map.js */ "./js/map.js");
...
/* harmony import */ var _js_function_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./js/function.js */ "./js/function.js");
...
let gallerySwiper;
let filterFn;
const modal = (0,_js_function_js__WEBPACK_IMPORTED_MODULE_8__.g)(".gallery-modal")
const filterSection = (0,_js_function_js__WEBPACK_IMPORTED_MODULE_8__.g)(".gallery-section");

if((0,_js_function_js__WEBPACK_IMPORTED_MODULE_8__.g)(".hero-swiper")) {
  new swiper__WEBPACK_IMPORTED_MODULE_5__["default"](".hero-swiper", {
...
if((0,_js_function_js__WEBPACK_IMPORTED_MODULE_8__.g)(".gallery-swiper")) {
  gallerySwiper = new swiper__WEBPACK_IMPORTED_MODULE_5__["default"](".gallery-swiper", {
...
if ((0,_js_function_js__WEBPACK_IMPORTED_MODULE_8__.g)(".reviews-swiper")) {
  new swiper__WEBPACK_IMPORTED_MODULE_5__["default"](".reviews-swiper", {
    modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_7__.Navigation],
    slidesPerView: 1,
    spaceBetween: 20,
    navigation: {
...
if ((0,_js_function_js__WEBPACK_IMPORTED_MODULE_8__.g)(".team-swiper")) {
  new swiper__WEBPACK_IMPORTED_MODULE_5__["default"](".team-swiper", {
    modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_7__.Navigation],
    slidesPerView: 1,
    spaceBetween: 20,
    navigation: {
...
if ((0,_js_function_js__WEBPACK_IMPORTED_MODULE_8__.g)(".mini-swiper")) {
  (0,_js_function_js__WEBPACK_IMPORTED_MODULE_8__.g)(".mini-swiper", document, true).forEach((swiper) => {
    new swiper__WEBPACK_IMPORTED_MODULE_5__["default"](swiper, {
      modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_7__.FreeMode, swiper_modules__WEBPACK_IMPORTED_MODULE_7__.Scrollbar],
      slidesPerView: 4,
      spaceBetween: 6,
      freeMode: true,
      scrollbar: {
...
if(filterSection) {
  const filters = (0,_js_function_js__WEBPACK_IMPORTED_MODULE_8__.g)(".gallery-section__filters .filter", document, true);
  const images = (0,_js_function_js__WEBPACK_IMPORTED_MODULE_8__.g)(".gallery-section__images .image", document, true);
  const isFull = (0,_js_function_js__WEBPACK_IMPORTED_MODULE_8__.has)(filterSection, ".full");
  

  filterFn = (filter) => {
    if(!filters) return;
    const slug = filter.getAttribute("data-slug");
    (0,_js_function_js__WEBPACK_IMPORTED_MODULE_8__.remove)(filters);
    (0,_js_function_js__WEBPACK_IMPORTED_MODULE_8__.add)(filter);

    const filteredImages = images.filter((image) => {
      return slug === "all" || image.getAttribute("data-slug") === slug;
    });

    (0,_js_function_js__WEBPACK_IMPORTED_MODULE_8__.remove)(images);
    (0,_js_function_js__WEBPACK_IMPORTED_MODULE_8__.add)(isFull ? filteredImages : filteredImages.slice(0, (0,_js_function_js__WEBPACK_IMPORTED_MODULE_8__.respond)("md") ? 6 : 5));
  };
...
document.onclick = (e) => {
  if((0,_js_function_js__WEBPACK_IMPORTED_MODULE_8__.has)(e.target, ".gallery-section__filters .filter")) {
    filterFn?.(e.target);
  } else if ((0,_js_function_js__WEBPACK_IMPORTED_MODULE_8__.has)(e.target, "#burger")) {
    const btn = (0,_js_function_js__WEBPACK_IMPORTED_MODULE_8__.g)("#burger");
    const menu = (0,_js_function_js__WEBPACK_IMPORTED_MODULE_8__.g)(".burger-menu");
    window.scrollTo(0, 0);
    (0,_js_function_js__WEBPACK_IMPORTED_MODULE_8__.toggle)([btn, menu]);
  } else if((0,_js_function_js__WEBPACK_IMPORTED_MODULE_8__.has)(e.target, ".gallery-section__images .image")) {
    const image = e.target.closest(".image");
    const index = Number(image.getAttribute("data-index"));
    gallerySwiper?.slideTo(index);
    (0,_js_function_js__WEBPACK_IMPORTED_MODULE_8__.add)(modal);
  } else if((0,_js_function_js__WEBPACK_IMPORTED_MODULE_8__.has)(e.target, ".gallery-modal .cross")) {
    (0,_js_function_js__WEBPACK_IMPORTED_MODULE_8__.remove)(modal);
